...
#define	DOUT			(GPIOB,GPIO_Pin_14)
#define	DOUT_L		GPIO_ResetBits(GPIOB,GPIO_Pin_14)
#define	DOUT_H		GPIO_SetBits(GPIOB,GPIO_Pin_14)
#define DO_IS_H		(GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_14) == Bit_SET)

#define	DIN				(GPIOB,GPIO_Pin_15)
#define	DIN_L			GPIO_ResetBits(GPIOB,GPIO_Pin_15)
#define	DIN_H			GPIO_SetBits(GPIOB,GPIO_Pin_15)

#define	SCLK			(GPIOB,GPIO_Pin_13)
